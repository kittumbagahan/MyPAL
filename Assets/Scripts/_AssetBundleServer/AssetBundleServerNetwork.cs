...
namespace _AssetBundleServer
{
    public class AssetBundleServerNetwork : MonoBehaviour
    {
        ...
        // kit
        [SerializeField] private ushort mPort = 14937;
        ...
        public bool useElo;
        public bool useInlineChat;
        public bool useMainThreadManagerForRPCs = true;

        public bool useTCP;

        public ClientSendFile clientSendFile { get; private set; }
        ...
        private void Start()
        {
            ...
            clientSendFile = GetComponent<ClientSendFile>();
            ...
            if (!useTCP) NetWorker.PingForFirewall(mPort);
        ...
        public void ConnectToMatchmaking()
        {
            ...
            if (mgr == null && networkManager == null)
                throw new Exception("A network manager was not provided, this is required for the tons of fancy stuff");
        ...
        public void Host()
        {
            ...
            else
            {
                ...
                if (natServerHost.Trim().Length == 0)
                    ...
                    {
                        MessageBox.ins.ShowOk("A server already exist. Please check your network connection.",
                            MessageBox.MsgIcon.msgInformation, null);
                    }
                else
            ...
            server.playerAccepted +=
                Server_playerAccepted; //if will be put on a button add flag playeraccepted in this callback
            // kit, event                      
            Connected(server);
        }
        ...
        private void Server_playerAccepted(NetworkingPlayer player, NetWorker sender)
        {
            ...
            MainThreadManager.Run(() =>
            {
                ...
                // TEST!!!
                var abd = new AssetBundleDataCollection();
                ...
                abd.lstAssetBundleData.Add(new AssetBundleData(
                    "https://www.dropbox.com/s/qnfwtm6bco2ytgu/assetbundlebookshelf?dl=1", 0,
                    AssetBundleCategory.BOOKSHELF_SCENE, 1, ""));
                abd.lstAssetBundleData.Add(new AssetBundleData(
                    "https://www.dropbox.com/s/pcfd6movomjr5vy/book_test_1_scene?dl=1", 0,
                    AssetBundleCategory.BOOK_SCENE, 1, "book_test_1"));
                abd.lstAssetBundleData.Add(new AssetBundleData(
                    "https://www.dropbox.com/s/y23n8l6bq187bv8/book_test_1_act1_activity?dl=1", 0,
                    AssetBundleCategory.ACTIVITY_SCENE, 1, "book_test_1_Act1"));
                abd.lstAssetBundleData.Add(new AssetBundleData(
                    "https://www.dropbox.com/s/clbtoe2lg7hija0/launcher_scene?dl=1", 0,
                    AssetBundleCategory.LAUNCHER_SCENE, 1, ""));
                abd.lstAssetBundleData.Add(new AssetBundleData(
                    "https://www.dropbox.com/s/xk75yvygktz96mh/book_test_1_dataset.txt?dl=1", 0,
                    AssetBundleCategory.SECTION_BOOK_DB_DATA_FILE, 1, ""));
                abd.lstAssetBundleData.Add(new AssetBundleData(
                    "https://www.dropbox.com/s/mwom3k2dn5zcotv/storybook_activity_scenes_data_file?dl=1", 0,
                    AssetBundleCategory.STORYBOOK_ACTIVITY_SECLECTION_DATA_FILE, 1, ""));
                ...
                if (OnClientAccepted != null) OnClientAccepted();
            });
        }
        ...
        private void CreateInlineChat(UnityEngine.SceneManagement.Scene arg0, LoadSceneMode arg1)
        {
            SceneManager.sceneLoaded -= CreateInlineChat;
        ...
        private IEnumerator _FindServer()
        {
        ...
        private IEnumerator _FindServerLoading()
        {
            var counter = 0;
            var status = "";
            while (isServerFound == false)
